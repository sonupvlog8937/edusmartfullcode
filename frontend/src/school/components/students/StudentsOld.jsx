  ...
  const handleEdit = (id) => {
    ...
    axios
      ...
      .then((resp) => {
        ...
        Formik.setFieldValue("roll_number", resp.data.data.roll_number || "")
        Formik.setFieldValue("address", resp.data.data.address || "")
        Formik.setFieldValue("aadhar_number", resp.data.data.aadhar_number || "")
  ...
  const Formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (isEdit) {
        ...
        fd.append("roll_number", values.roll_number);
