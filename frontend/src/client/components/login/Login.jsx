...
export default function Login() {
    ...
    useEffect(() => {
        ...
        if (session === "expired") {
            ...
            setMessage("You do not have access to that resource.");
            setType("error");
            const next = new URLSearchParams(searchParams);
            next.delete("session");
            setSearchParams(next, { replace: true });
            ...
            if(loginType=="school_owner"){
             ...
             navUrl='/school'
                ...
                axios.post(url, {...values}).then(resp=>{    
                    ...
                    setMessage(e.response?.data?.message || "Sign-in failed. Please try again.");
                    setType("error")
                })
    ...
    return (<Box component={'div'} sx={{width:"100%", height:"80vh", background:"url(https://res.cloudinary.com/dn7ko6gut/image/upload/v1776553369/ChatGPT_Image_Apr_19_2026_04_32_27_AM_q8kxty.png)", backgroundSize:"cover"}}>
